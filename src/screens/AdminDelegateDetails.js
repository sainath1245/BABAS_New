...
const AdminDelegateDetails = ({ route, navigation }) => {
    ...
    console.log(supervisorID, newApproverId, isEmployeeDelegation, employeeID);
  ...
  : {
    ...
    const delegationEndPoint = isEmployeeDelegation ? 'Admin/EmployeeDelegation' : 'Admin/SupervisorDelegation'
