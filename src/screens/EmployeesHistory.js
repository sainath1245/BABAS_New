...
import {
    ActivityIndicator,
    FlatList, Image, StatusBar, Text, TouchableOpacity, View, Alert, Platform
} from 'react-native';
                    ...
                    item.requestStatus === 'Rejected' ?
                        <View style={{ width: width * .9, backgroundColor: '#ffebeb', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                            <View onLayout={onLayout}>
                                ...
                                <Text
                                    numberOfLines={1}
                                    style={historyPageStyles.employee_name_text_temp}>
                                    {item.designation}
                                </Text>
                            ...
                            <View style={{ flexDirection: 'row' }}>
                                ...
                                <View style={{ flexDirection: 'column', alignItems: 'center', padding: 5, justifyContent: 'center', backgroundColor: '#fbdbdb', height: item_height }}>
                                    ...
                                    <Text style={{ fontFamily: 'OpenSans-Medium', marginTop: 10, fontSize: 12 }}>
                                        Rejected
                                    </Text>
                                </View>
                            </View>
